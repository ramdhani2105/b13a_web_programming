- untuk membuat teks miring bisa menggunakan tag i atau em
- untuk membuat teks tebal bisa menggunakan tag strong atau b

membuat folder list dengan isi file index_list.html
membuat ol dan ul dan membuat list didalam list
membuat folder heading
...
<a href="../belajar_gambar/index_gambar.html">Klik Disini Untuk Menuju Halaman Gambar</a>
...
belajar div
-----
<div class="header">Portofolio Sederhana</div>
<div class="navbar">
    <ul>
        <li>Home</li>
        <li>Contact</li>
...
*btn-primary dan btn-warning utk memberikan simbol warna pada tombol

jika ingin load cdn bootstrap untuk template
------
https://getbootstrap.com/docs/4.3/getting-started/introduction/

*rowspan untuk melebar ke bawah dan colspan untuk melebar ke kanan
